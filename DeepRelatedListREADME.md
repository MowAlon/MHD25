...
![Deep Related List (top) and standard "Dynamic Related List - Single" (bottom) comparison](/README_images/DeepRelatedList_related_list_comparison.png)

<hr>

**_Lightning App Builder inputs_**  
![Lightning App Builder inputs](/README_images/DeepRelatedList_lightning_app_builder_inputs.png)
